...
export default function ProductDetails({product} : ProductDetailsProps) {
    ...
    const fetcher = useFetcher() // Hace cambios en la BD sin necesidad de cambiar la pantalla ni redireccionar (Como agregar un like a un post)
            ...
            <div className="flex gap-2 items-center">
                ...
                >
                    <input 
                        type="submit"
                        value='Eliminar'
                        className="bg-red-600 text-white rounded-lg w-full p-2 uppercase font-bold text-xs hover:cursor-pointer"
                    />
                </Form>
            </div>
        </td>
